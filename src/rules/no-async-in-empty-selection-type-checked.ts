...
import { isTrackItemSelectionStaticType } from "../util/type-guards";
...
export default createRule<[], MessageIds>({
  name: "no-async-in-empty-selection-type-checked",
  meta: {
    type: "problem",
    docs: {
      description:
  ...
  create(context) {
    ...
    function isCreateEmptySelectionCallback(node: FunctionNode): boolean {
      ...
      return isTrackItemSelectionStaticType(receiverType);
    }
